...
class BatsmenScorecardAdapter(val mCtx : Context, val layoutId:Int, val employeeList:List<BatsmenScorecard>)
    : ArrayAdapter<BatsmenScorecard>(mCtx,layoutId,employeeList){
