...
class BatsmanFragment : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
       ...
       // listview = view.findViewById(R.id.listview1)
        ...
        if (ranktype=="Men's Rankings"){
            ...
            ref.child("Men").child("Batsman").child("Test").addValueEventListener(object : ValueEventListener {
           ...
           // test.visibility= View.INVISIBLE
            ...
            ref.child("Women").child("Batsman").child("Test").addValueEventListener(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError?) {
                }
                override fun onDataChange(p0: DataSnapshot?) {
                    if (p0!!.exists()){
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.odi ->{
                ...
                employeeList = mutableListOf()
                if (ranktype=="Men's Rankings"){
                    ref.child("Men").child("Batsman").child("Odi").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
                        override fun onDataChange(p0: DataSnapshot?) {
                            if (p0!!.exists()){
                    ...
                    ref.child("Women").child("Batsman").child("Odi").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
                        override fun onDataChange(p0: DataSnapshot?) {
                            if (p0!!.exists()){
            ...
            R.id.t20 ->{
                ...
                employeeList = mutableListOf()
                if (ranktype=="Men's Rankings"){
                    ref.child("Men").child("Batsman").child("T20").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
                        override fun onDataChange(p0: DataSnapshot?) {
                            if (p0!!.exists()){
                    ...
                    ref.child("Women").child("Batsman").child("T20").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
                        override fun onDataChange(p0: DataSnapshot?) {
                            if (p0!!.exists()){
