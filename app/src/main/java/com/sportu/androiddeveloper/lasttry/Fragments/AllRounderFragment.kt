...
class AllRounderFragment : Fragment() ,View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Toast.makeText(context, ranktype, Toast.LENGTH_SHORT).show()
        ...
        if (ranktype=="Men's Rankings") {
           // test.visibility= View.VISIBLE
            ref.child("Men").child("Allrounder").child("Test").addValueEventListener(object : ValueEventListener {
           ...
           // test.visibility= View.INVISIBLE
            ...
            ref.child("Women").child("Allrounder").child("Test").addValueEventListener(object : ValueEventListener {
                override fun onCancelled(p0: DatabaseError?) {
                }
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.odi ->{
                ...
                if (ranktype=="Men's Rankings") {
                    ref.child("Men").child("Allrounder").child("Odi").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
                    ...
                    ref.child("Women").child("Allrounder").child("Odi").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
            ...
            R.id.t20 ->{
                ...
                if (ranktype=="Men's Rankings") {
                    ref.child("Men").child("Allrounder").child("T20").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
                    ...
                    ref.child("Women").child("Allrounder").child("T20").addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError?) {
                        }
